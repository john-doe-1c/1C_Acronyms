...
|АС|Автономный сервер|https://v8.1c.ru/platforma/avtonomnyy-server/
|БД|База данных
...
|КЗР|Корректировка записей регистров|Документ, присутствующий в большинстве "старых" типовых конфигураций (в современных типовых вместо него теперь "ОперацияБух" или "КорректировкаРегистров")
...
|ММ|Модуль менеджера
|МО|Модуль объекта
|МП|Мобильное приложение<br>или<br>Маркетплейс|https://v8.1c.ru/platforma/arhitektura-mobilnoy-platformy/<br><br><br>
|МФ|Модуль формы
...
|ЮИ|Транслит с UI (**u**ser **i**nterface)|https://ru.wikipedia.org/wiki/Интерфейс_пользователя
|ЮХ|Транслит с UX (**u**ser e**x**perience)|https://ru.wikipedia.org/wiki/Опыт_взаимодействия
